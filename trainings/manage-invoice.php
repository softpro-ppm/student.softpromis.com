                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Manage Invoice</h2>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div style="overflow: auto;">
                                            <table id="example"
                                                ...
                                                <tbody>
                                                    <?php $sql = "SELECT tblinvoice.*,tbltrainingcenter.trainingcentername,tblscheme.SchemeName,tblsector.SectorName,tbljobroll.jobrollname,tblbatch.batch_name from tblinvoice JOIN tbltrainingcenter JOIN tblscheme JOIN tblsector JOIN tbljobroll JOIN tblbatch ON tblinvoice.trainingcenterID = tbltrainingcenter.TrainingcenterId AND tblinvoice.schemeID = tblscheme.SchemeId AND tblinvoice.sectorID = tblsector.SectorId AND tblinvoice.jobrollID = tbljobroll.JobrollId AND tblinvoice.batchID = tblbatch.id";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlentities($result->trainingcentername); ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a class="badge badge-primary"
                                                                href="edit-invoice.php?invoiceid=<?php echo htmlentities($result->invoiceID); ?>"><i
                                                                    class="fa fa-edit" title="Edit Record"></i> </a>
                                                            <a class="badge badge-danger delete"
                                                                id='del_<?php echo htmlentities($result->invoiceID); ?>'><i
