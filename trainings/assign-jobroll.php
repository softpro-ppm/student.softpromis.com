                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Assign Jobroll</h2>
                            </div>
                            <!-- /.col-md-6 text-right -->
                        </div>
                        <!-- /.row -->
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Assign Jobroll</li>
                                </ul>
                            </div>
                        </div>
                        <!-- /.row -->
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <select name="jobrollid" class="form-control clid"
                                                        required="required">
                                                        <option value="">Select Jobroll Name</option>
                                                        <?php $sql = "SELECT * from tbljobroll";
                                                        $query = $dbh->prepare($sql);
                                                        $query->execute();
                                                        ...
                                                        <option
                                                            value="<?php echo htmlentities($jobroll->JobrollId); ?>">
