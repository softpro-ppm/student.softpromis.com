                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Manage Job Roll</h2>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li> Job Roll</li>
                                    <li class="active">Manage Job Roll</li>
                                </ul>
                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="badge badge-info"
                                                                href="edit-jobroll.php?jobrollid=<?php echo htmlentities($result->JobrollId); ?>"><i
                                                                    class="fa fa-edit" title="Edit Record"></i> </a>

                                                            <a class="badge badge-danger delete"
                                                                id='del_<?php echo htmlentities($result->JobrollId); ?>'><i
