                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Manage Training Center</h2>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Manage Training Center</li>
                                </ul>
                            </div>
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                <h5>View Training Center Info</h5>
                                            </div>
                                        </div>
                                        <?php if ($msg) { ?>
                                                ...
                                                <table id="example" class="display table table-striped table-bordered"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlentities($result->spocemailaddress); ?>
                                                            </td>
                                                            <td><?php echo htmlentities($result->tcuserid); ?></td>
                                                            <td><?php echo htmlentities($result->tcpassword); ?></td>
                                                            <td><?php echo htmlentities($result->DateCreated); ?></td>
                                                            <td><?php echo htmlentities($result->DateModified); ?></td>
                                                            <td>
                                                                <a class="badge badge-info"
                                                                    href="edit-trainingcenter.php?trainingcenterid=<?php echo htmlentities($result->TrainingcenterId); ?>"><i
                                                                        class="fa fa-edit" title="Edit Record"></i> </a>

                                                                <a class="badge badge-danger delete"
                                                                    id='del_<?php echo htmlentities($result->TrainingcenterId); ?>'><i
