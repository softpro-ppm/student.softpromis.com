                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Update Batch Details</h2>
                            </div>
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <div class="">
                                                    ...
                                                    <span class="help-block">Eg- Enter the batch name as per
                                                        portal</span>
                                                </div>
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="success" class="control-label">Scheme</label>
                                                <div class="">
                                                    <input type="text" name="classnamenumeric"
                                                        value="<?php echo htmlentities($result->ClassNameNumeric); ?>"
                                                        required="required" class="form-control" id="success">
                                                    <span class="help-block">Eg- PMKVY,YTC,SC etc</span>
                                                </div>
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="success" class="control-label">TC Name</label>
                                                <div class="">
