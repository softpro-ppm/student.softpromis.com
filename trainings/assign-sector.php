                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Assign Sector</h2>
                            </div>
                            <!-- /.col-md-6 text-right -->
                        </div>
                        <!-- /.row -->
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Assign sector</li>
                                </ul>
                            </div>
                        </div>
                        <!-- /.row -->
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" method="post">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <select name="trainingcenterid" class="form-control clid"
                                                        ...
                                                        if ($query->rowCount() > 0) {
                                                            foreach ($trainings as $training) {   ?> <option
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <select name="sectorid" class="form-control clid" id="classid"
                                                        required="required">
                                                        <option value="">Select sector Name</option>
                                                        <?php $sql = "SELECT * from tblsector";
                                                        $query = $dbh->prepare($sql);
                                                        $query->execute();
                                                        $sectors = $query->fetchAll(PDO::FETCH_OBJ);
                                                        if ($query->rowCount() > 0) {
                                                            foreach ($sectors as $sector) {   ?> <option
                                                            value="<?php echo htmlentities($sector->SectorId); ?>">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-2 col-sm-10">
                                                    <button type="submit" name="submit" id="submit"
                                                        class="btn btn-primary">Assign Sector</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
