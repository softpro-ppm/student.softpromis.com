...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $dob = $_POST['dob'];
        $status = 1;
        $sql = "INSERT INTO  tblstudents(StudentName,RollId,AadharId,StudentEmail,Gender,ClassId,DOB,Status) VALUES(:studentname,:roolid,:aadharid,:studentemail,:gender,:classid,:dob,:status)";
        $query = $dbh->prepare($sql);
        $query->bindParam(':studentname', $studentname, PDO::PARAM_STR);
        $query->bindParam(':roolid', $roolid, PDO::PARAM_STR);
        $query->bindParam(':aadharid', $aadharid, PDO::PARAM_STR);
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="default" class="col-sm-2 control-label">Phone Number
                                                    Id</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="aadharid" class="form-control"
                                                        id="aadharid" maxlength="12" required="required"
                                                        autocomplete="off">
                                                </div>
                                            </div>
