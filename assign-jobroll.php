...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO tblassignjobroll(trainingcenter_id, scheme_id, sector_id, jobroll_id) VALUES(:trainingcenter_id, :scheme_id, :sector_id, :jobroll_id)";
        ...
        $query->bindParam(':jobroll_id', $jobrollid, PDO::PARAM_STR);
        $query->execute();
        $lastInsertId = $dbh->lastInsertId();
        if ($lastInsertId) {
            $msg = "Job Roll assigned successfully";
        } else {
            ...
            <div class="row">
                ...
                <main class="col-md-9 col-lg-10 px-md-4">
                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                        <h1 class="h2">Assign Job Roll</h1>
                    </div>
                    ...
                    <nav aria-label="breadcrumb" class="mb-4">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Assign Job Roll</li>
                        </ol>
                    </nav>
                    ...
                    <div class="card">
                        <div class="card-header bg-white py-3">
                            <h5 class="mb-0">Assign Job Roll to Training Center</h5>
                        </div>
                        <div class="card-body">
                            <form method="post">
                                <div class="mb-3">
                                ...
                                <button type="submit" name="submit" class="btn btn-primary">
                                    <i class="fas fa-check me-2"></i>Assign Job Roll
                                </button>
                            </form>
                        </div>
                    </div>
