...
<body class="bg-light">
                ...
                <main class="col-md-9 col-lg-10 px-md-4">
                    ...
                    <nav aria-label="breadcrumb" class="mb-4">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Manage Sectors</li>
                        </ol>
                    </nav>
                    ...
                    <div class="card">
                        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                            ...
                            <a href="create-sector.php" class="btn btn-success">
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit-sector.php?sectorid=<?php echo htmlentities($result->SectorId); ?>" 
                                                           class="btn btn-info btn-xs btn-action" title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <button class="btn btn-danger btn-xs btn-action delete" 
                                                                id="del_<?php echo htmlentities($result->SectorId); ?>" 
                                                                title="Delete">
    ...
    $(document).ready(function() {
        ...
        // Properly position buttons container explicitly
        ...
        $('#example tbody').on('click', '.delete', function() {
            ...
            if (confirm("Are you sure you want to delete this sector?")) {
                $.ajax({
                    url: 'action.php',
                    type: 'POST',
                    data: { id: id, action: "Delete sector" },
